...
static const _TelloState_Request_type_support_symbol_names_t _TelloState_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_interface, srv, TelloState_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tello_interface, srv, TelloState_Request)),
  }
};
...
{
  return &::tello_interface::srv::rosidl_typesupport_cpp::TelloState_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tello_interface, srv, TelloState_Request)() {
  return get_message_type_support_handle<tello_interface::srv::TelloState_Request>();
}
...
static const _TelloState_Response_type_support_symbol_names_t _TelloState_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_interface, srv, TelloState_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tello_interface, srv, TelloState_Response)),
  }
};
...
{
  return &::tello_interface::srv::rosidl_typesupport_cpp::TelloState_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tello_interface, srv, TelloState_Response)() {
  return get_message_type_support_handle<tello_interface::srv::TelloState_Response>();
}
...
static const _TelloState_type_support_symbol_names_t _TelloState_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_interface, srv, TelloState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tello_interface, srv, TelloState)),
  }
};
...
{
  return &::tello_interface::srv::rosidl_typesupport_cpp::TelloState_service_type_support_handle;
}
